...
(module typed-namespace-module typed/racket
  (require typed/rackunit typed/sugar net/url)
  (define-namespace-anchor typed-ns)
  (provide typed-ns))

(module untyped-namespace-module racket
  (require rackunit sugar net/url)
  (define-namespace-anchor untyped-ns)
  (provide untyped-ns))

(require 'typed-namespace-module)
(require 'untyped-namespace-module)

(define-syntax-rule (eval-with-namespaces (nss ...) exprs ...)
  (for-each (λ(ns) (eval '(begin exprs ...) (namespace-anchor->namespace ns))) (list nss ...)))
